...
public class caseToCaseUtil {
	...
	public static void uderScore2CamelCase(String[] motherSource) {
        ...
        StringBuilder result = changeCamel(underScore, len);

        String returnResult = "aaa";
    ...
    private static StringBuilder changeCamel(String underScore, int len) {
